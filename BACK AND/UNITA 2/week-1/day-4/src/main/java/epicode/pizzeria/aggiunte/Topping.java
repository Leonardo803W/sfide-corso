...
//entity per far gestire al framwork la classe, in oltre se non specifico il nome facendo: (name = "toppings"), il databese non avra problemi a riconoscere quale tabella fa parte l'entita
